...
More specifically, it is based off of the fourth version of "select_handler.py" 
...
class Agent():
	""" An agent, modelled after csp3-v0.95.c in iRobotInterface repo """
	def __init__(self):
		pass
