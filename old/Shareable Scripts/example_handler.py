#!python3
"""
A program providing an example of how to communicate with the iRobot Create.
It's not highly polished, but it may be useful.
...
# Displays the infrared sensors at the front of the robot 
	$ python example_handler.py /dev/ttyUSB0 28 29 30 31

# Displays information about the iRobot Create's battery
	$ python example_handler.py /dev/ttyUSB0 24 25 26


Tested with Python 3.4 on Ubuntu 12.04, using Anaconda as a package manager
"""
