...
TODO: Encapsulate robot in a class
"""
import select
import struct
...
def set_LED(ser, play_on=False, adv_on=False, pow_intensity=0, pow_color=0):
    pass

def low_side_drivers(ser, d0, d1, d2):
    pass

def digital_outputs(ser, bits):
    pass
...
def drive(ser, speed, radius):
    pass

def drive_direct(ser, left, right):
    pass
